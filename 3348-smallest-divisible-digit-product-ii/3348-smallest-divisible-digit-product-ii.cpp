...
class Solution {
    ...
    bool isReqMet(const vector<int>& freq) {
        return freq[2] == 0 && freq[3] == 0 && freq[5] == 0 && freq[7] == 0;
    }
...
public:
  ...
  int len = num.size();
        ...
        // Case 2: Attempt same length with higher digit at position pos
